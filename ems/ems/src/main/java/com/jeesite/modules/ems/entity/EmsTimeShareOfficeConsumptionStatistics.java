 ...
 * @version 2023-06-28
 */
@Table(name="ems_time_share_office_consumption_statistics", alias="a", label="峰平谷部门电耗表数据统计表信息", columns={
...
@AllArgsConstructor
@Data
@ApiModel(value = "EmsTimeShareOfficeConsumptionStatistics对象", description = "峰平谷部门电耗表数据统计表Entity")
public class EmsTimeShareOfficeConsumptionStatistics extends DataEntity<EmsTimeShareOfficeConsumptionStatistics> {
	...
	public EmsTimeShareOfficeConsumptionStatistics() {
		this(null);
	}
	
	public EmsTimeShareOfficeConsumptionStatistics(String id){
		super(id);
	}
