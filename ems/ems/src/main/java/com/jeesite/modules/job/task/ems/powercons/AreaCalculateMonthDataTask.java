...
public class AreaCalculateMonthDataTask {
    ...
    public void execute(String jobParam) throws ParseException {
        XxlJobHelper.log("######区域每月电耗计算定时任务【开始】######");
        log.info("######区域每月电耗计算定时任务【开始】######");
        ...
        stopWatch.stop();
        XxlJobHelper.log("######区域每月电耗计算定时任务【结束】######，耗时=》【{}s】", stopWatch.getTotalTimeSeconds());
        log.info("######区域每月电耗计算定时任务【结束】######，耗时=》【{}s】", stopWatch.getTotalTimeSeconds());
    }
