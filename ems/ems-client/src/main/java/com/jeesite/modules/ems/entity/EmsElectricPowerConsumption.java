 ...
 * @version 2023-05-25
 */
@Table(name = "ems_electric_power_consumption", alias = "a", label = "电耗表信息", columns = {
        ...
        @Column(name = "mqtt_ts", attrName = "mqttTs", label = "设备上传时间， 2023-03-24 22:00:12"),
...
@AllArgsConstructor
@Data
public class EmsElectricPowerConsumption extends DataEntity<EmsElectricPowerConsumption> {
    ...
    public EmsElectricPowerConsumption() {
        this(null);
    }

    public EmsElectricPowerConsumption(String id) {
        super(id);
    }
